...
(
   ...
   (
      ...
      (
         ...
         'year' => array(2007, 2008, 2009, 2010),
         'uri' => 'Subaru/Impreza/Subaru+Impreza+WRX',
      ),
      23 => array
      (
         'name' => 'Subaru Outback',
         'year' => array(2007, 2008, 2009, 2010),
         'uri' => 'Subaru/Outback/Subaru+Outback',
      ),
      24 => array
      (
         'name' => 'Subaru Tribeca',
         'year' => array(2007, 2008, 2009, 2010),
         'uri' => 'Subaru/Tribeca/Subaru+Tribeca',
      ),
      25 => array
      (
         'name' => 'Lexus RX 350',
         'year' => array(2007, 2008, 2009, 2010),
         'uri' => 'Lexus/RX/Lexus+RX+350',
      ),
      26 => array
      (
         'name' => 'Lexus GS 350',
         'year' => array(2007, 2008, 2009),
         'uri' => 'Lexus/GS/Lexus+GS+350',
      ),
      27 => array
      (
         'name' => 'Lexus ES 350',
         'year' => array(2007, 2008, 2009),
         'uri' => 'Lexus/ES/Lexus+ES+350',
      ),
      28 => array
      (
         'name' => 'Audi A8',
      ...
      (
         ...
         'year' => array(2006, 2007, 2008, 2009),
         'uri' => 'Mercedes-Benz/E-Class/ECLASS+MERCEDESBENZ',
      ),
      34  => array
      (
         'name' => 'Mercedes-Benz GLK-Class',
         'year' => array(2010),
         'uri' => 'Mercedes-Benz/GLK-Class/GLKCLASS+MERCEDESBENZ',
      ),
      35  => array
      (
         'name' => 'Mercedes-Benz C-Class',
         'year' => array(2008, 2009),
         'uri' => 'Mercedes-Benz/C-Class/CCLASS+MERCEDESBENZ',
      ),
      36  => array
      (
         'name' => 'Mercedes-Benz S-Class',
         'year' => array(2007),
         'uri' => 'Mercedes-Benz/S-Class/SCLASS+MERCEDESBENZ',
      ),
      37 => array
      (
         'name' => 'Lexus IS 350',
         'year' => array(2006, 2007, 2008, 2009),
         'uri' => 'Lexus/IS/Lexus+IS+350',
      ),
      38 => array
      (
         'name' => 'Lexus IS 350',
      ...
      (
         'name' => 'BMW 1-Series',
         'year' => array(2006, 2007, 2008, 2009, 2010),
         'uri' => 'BMW/1+Series/BMW+1SERIES',
      ),
      40 => array
      (
         'name' => 'BMW 3-Series',
         'year' => array(2006, 2007, 2008, 2009, 2010),
         'uri' => 'BMW/3+Series/BMW+3SERIES',
      ),
      41 => array
      (
         'name' => 'BMW 5-Series',
         'year' => array(2006, 2007, 2008, 2009),
         'uri' => 'BMW/5+Series/BMW+5SERIES',
      ),
      42  => array
      (
         'name' => 'BMW X3',
