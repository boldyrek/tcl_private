...
class Vincode_Lexuspartsnow extends Vincode {

   const URL = 'http://www.lexuspartsnow.com/Page_Product/VinSearch.aspx?vinnum=';
      ...
      if ($headers = Arr::get($response, 'headers'))
      {
         if ($url = parse_url(Arr::get($headers, 'Location')))
         {
            ...
            (
               ...
               'color_inside' => Arr::get($query, 'trimcode'),
               'color_outside' => Arr::get($query, 'paintcode')
            );
         }
