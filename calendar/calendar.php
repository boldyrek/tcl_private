...
require_once($_SERVER['DOCUMENT_ROOT'].'/ccl/calendar/libraries/grab_globals.lib.php');
require_once($_SERVER['DOCUMENT_ROOT'].'/ccl/calendar/libraries/common.lib.php');
require_once($_SERVER['DOCUMENT_ROOT'].'/ccl/calendar/libraries/header_http.inc.php');
?>
...
<script type="text/javascript" src="/ccl/calendar/libraries/tbl_change.js"></script>
