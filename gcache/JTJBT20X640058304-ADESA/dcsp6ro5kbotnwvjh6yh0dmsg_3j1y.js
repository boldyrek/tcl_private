...
// Created: 10/05/2009 10:12:35 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcs0n97z00000043psulsms0y_8s4s";
	this.domain="statse.webtrendslive.com";
	this.timezone=-5;
	this.fpcdom=".dealerblock.ca";
	this.onsitedoms="";
...
WebTrends.prototype.dcsMultiTrack=function(){
	...
	if (args.length%2==0){
		...
		this.dcsFPC();
		this.dcsTag();
		// Begin Double-tagging customizations
		// Remove this section to return to single-tagging
	        	this.dcsid = "dcsp6ro5kbotnwvjh6yh0dmsg_3j1y";
	        	this.domain = "webtrendssdc.adesa.com";
	        	this.dcsTag();						// Run with the clients local dcsID
	        	this.dcsid="dcs0n97z00000043psulsms0y_8s4s";		// Put it back the original for multiTrack
	        	this.domain = "statse.webtrendslive.com";
        	// End Double-tagging customizations
        	var date = new Date();
        	var curDate = null;
		do { curDate = new Date(); }
...
WebTrends.prototype.dcsTag=function(){
	...
	for (var i=0;i<keys.length;i++){
		...
		if (WT[key]){
			// Begin Double-tagging customizations
			// Uncomment when returning to single-tagging - DO NOT delete the line!
