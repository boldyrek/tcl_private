    ...
    <td valign="top"><div class="auth_form">
        <form action="'.$this->root_path.'" method="post" name="auth" id="auth">
          <table width="296" border="0" cellspacing="1" cellpadding="3">
            ...
            <tr>
              <td>&nbsp;</td>
              <td height="25" class="caption"><input type="checkbox" name="save_login" id="store" style="border:0px; width:20px;" '.((isset($checked))?$checked:'').'> <label for="store" style="cursor:hand; cursor:pointer;">запомнить меня</login></td>
            </tr>
			<tr>
              <td>&nbsp;</td>
