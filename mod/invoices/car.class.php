...
class carSelect {
	var $carSQLlist;
	var $haveCars;
//	var $translate = Zend_Registry::get('translation');
				...
				<table class="list" border="0" width="750" cellspacing="0" style="border-top:5px; background-color:transparent;">
					<tr>
						...
						<td width="50" class="title">
							<a href="/?ref=form.car&car_id='.$id.'"><img src="img/ccl/more_info.gif" border="0" align="absmiddle" hspace="3" alt="Открыть форму автомобиля" title="Открыть форму автомобиля"></a></td>
