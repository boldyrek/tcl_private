...
.mainTablePaid {
	/*background-image: url(../paid-full.gif);*/
...
<table width="629" align="center" cellpadding="0" cellspacing="0" class="topBg" style="background-image: url(/img/invoice.gif);">
  <tr>
    <td>

<table width="100%" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="349" height="125" class="fontFront">
    Sobex Enterprises Inc.<br>
    92 Dovetail Drive<br>
    Richmond Hill, ON<br> 
    Canada, L4E5A7 <br>
    Phone: 4168405849<br>
    </td>
