...
class CommentTemplates{
	...
	function EditButton($commentId)
	{
		...
		<a href="javascript:HideAndDel('.$commentId.');" onClick="confirm(\'Вы действительно хотите удалить этот комментарий?\')">Удалить</a>
		</div>
	...
	{
		return "<div style='background:#EFEFEF;padding:5px;color:#0066CC;font-size:12px;cursor:pointer;' id='showLink'><b>Добавить комментарий</b></div>";
	}
