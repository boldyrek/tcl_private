...
class ExpensesSave extends Proto {
...
//		$signer = $paid ? intval($_SESSION['login_id']) : 0;
		...
		$request = "UPDATE `ccl_".ACCOUNT_SUFFIX."expenses` SET
...
*/
		$this->redirect($this->root_path.'?mod=expenses&sw=form&expense='.intval($_GET['id']).'&success');
	}
}
?>